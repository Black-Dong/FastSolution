 ...
 * @date 2022-08-25
 */
public interface RubbishBucketMapper
{
    /**
     * 查询垃圾站管理
     *
     * @param bucketId 垃圾站管理主键
     * @return 垃圾站管理
     */
    public RubbishBucket selectRubbishBucketById(String bucketId);
     ...
     * @return 结果
     */
    public int deleteRubbishBucketById(String bucketId);
