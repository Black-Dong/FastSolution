...
import team.fs.activiti.service.IProcessDefinitionService;
import team.fs.common.core.page.PageDomain;
import team.fs.common.core.page.TableSupport;
import team.fs.common.core.text.Convert;
...
public class ProcessDefinitionService implements IProcessDefinitionService {
     ...
     */
    @Override
    public Page<team.fs.activiti.domain.ProcessDefinition> listProcessDefinition(team.fs.activiti.domain.ProcessDefinition processDefinition) {
        PageDomain pageDomain = TableSupport.buildPageRequest();
        Integer pageNum = pageDomain.getPageNum();
        Integer pageSize = pageDomain.getPageSize();

        Page<team.fs.activiti.domain.ProcessDefinition> list = new Page<>();
        ...
        for (ProcessDefinition definition: processDefinitionList) {
            ...
            team.fs.activiti.domain.ProcessDefinition entity = new team.fs.activiti.domain.ProcessDefinition();
