...
import static team.fs.common.core.domain.AjaxResult.error;
import static team.fs.common.core.domain.AjaxResult.success;
...
public class ModelerController extends BaseController {
    ...
    public TableDataInfo list(ModelEntityImpl modelEntity) {
        ...
        // 条件过滤
        if (team.fs.common.utils.StringUtils.isNotBlank(modelEntity.getKey())) {
            modelQuery.modelKey(modelEntity.getKey());
        }
        if (team.fs.common.utils.StringUtils.isNotBlank(modelEntity.getName())) {
