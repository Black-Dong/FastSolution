package team.fs.common.utils.http;
...
public class HttpUtils {
    ...
    public static String sendGet(String url, String param, String contentType) {
        return sendGet(url, param, null, Constants.UTF8);
    ...
    public static String sendGet(String url, String param, Map<String, String> header, String contentType) {
